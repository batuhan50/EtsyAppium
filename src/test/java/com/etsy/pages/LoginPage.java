...
public class LoginPage {
  ...
  //  AndroidFindBy
    ...
    private String signInFormLocatorID = "com.etsy.android:id/button_signin";
   ...
   public void loginWithEtsyAccount(String email,String password){
       ...
       WebElement signInButton = Driver.getDriver().findElement(MobileBy.id(signInFormLocatorID));
       signInButton.click();
